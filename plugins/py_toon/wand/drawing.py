...
class Drawing(Resource):
    ...
    def rectangle(self, x, y, xx, yy):
        library.DrawRectangle(self.resource, int(x), int(y), int(xx), int(yy))

    def round_rectangle(self, x, y, xx, yy, r1, r2):
        library.DrawRoundRectangle(self.resource, int(x), int(y), int(xx), int(yy), r1, r2)

    def extent(self, x, y):
        library.MagickSetImageExtent(self.resource, x, y)
